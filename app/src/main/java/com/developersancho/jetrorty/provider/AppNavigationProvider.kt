...
import com.developersancho.maps.destinations.MapsScreenDestination
...
class AppNavigationProvider constructor(
    ...
    override fun openMaps(text : String) {
        navController.navigateTo(MapsScreenDestination(text))
    }
